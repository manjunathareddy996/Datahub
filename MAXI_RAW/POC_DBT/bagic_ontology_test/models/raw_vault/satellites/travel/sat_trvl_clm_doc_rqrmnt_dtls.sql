...
-- Travel Claim Document Requirement Details
-- Hub: hub_clm | Attributes: 59
-- Source: NONHLTH_TRV_CLM_VW_DATA_CLAIM_DETAILS_CLAIM_ATTRIBUTE_MULTI_SET_PROPERTY_MULTI_SET_DETAIL_PROPERTY
...
source AS (
    SELECT src.*
    FROM {{ ref('stg_trvl_clm_nonhlth_trv_clm_vw_data_cd_clm_attribute_msp_ms_51') }} src
),
