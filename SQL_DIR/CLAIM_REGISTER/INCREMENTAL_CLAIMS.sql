CREATE OR REPLACE PROCEDURE BAGIC_DEV_CURATED_DB.TRANSACTIONAL.INCREMENTAL_CLAIMS("MIRROR_DB" VARCHAR(16777216), "F_DATE" DATE DEFAULT CURRENT_DATE(), "T_DATE" DATE DEFAULT CURRENT_DATE())
