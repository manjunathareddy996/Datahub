CREATE OR REPLACE PROCEDURE BAGIC_DEV_CURATED_DB.TRANSACTIONAL.INSERT_PR_DATA("MIRROR_DB" VARCHAR(16777216), "P_FROM_DATE" DATE DEFAULT TRUNCDATETOMonth(DATE_ADDDAYSTODATE(CAST(NEGATE(1) AS NUMBER(1,0)), CURRENT_DATE())), "P_TO_DATE" DATE DEFAULT DATE_ADDDAYSTODATE(CAST(NEGATE(1) AS NUMBER(1,0)), CURRENT_DATE()))
