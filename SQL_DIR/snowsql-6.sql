CREATE OR REPLACE PROCEDURE TRANSACTIONAL.INSERT_PR_DATA("MIRROR_DB" VARCHAR(1677216), "P_FROM_DATE" DATE DEFAULT TRUNCDATETOMonth(DATE_ADDDAYSTODATE(CAST(NEGATE(1) AS NUMBER(1,0)), CURRENT_DATE())), "P_TO_DATE" DATE DEFAULT DATE_ADDDAYSTODATE(CAST(NEGATE(1) AS NUMBER(1,0)), CURRENT_DATE()))
