...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_LEGAL_PANEL, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_legal_panel; Maximus-only augmented table.
...
src_payload:
  ...
  - 'NOOFBRIEFS'
src_hashdiff: 'HASHDIFF_AUG_PARTY_LEGAL_PANEL'
