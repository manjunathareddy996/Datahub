...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_LNK_ROLE_AGENT, at HUB_PARTY grain.
-- Writes the SAME physical table as partner_dv_dbt's sat_aug_lnk_role_agent.
