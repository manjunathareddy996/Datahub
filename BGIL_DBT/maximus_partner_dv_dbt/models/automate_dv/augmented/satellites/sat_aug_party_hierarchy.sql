...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_HIERARCHY, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_hierarchy; Maximus-only augmented table.
...
src_payload:
  ...
  - 'TRANSFERINDICATOR'
  - 'ZONECODE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_HIERARCHY'
