...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_LNK_ROLE_SURVEYOR, at HUB_PARTY grain.
-- Writes the SAME physical table as partner_dv_dbt's sat_aug_lnk_role_surveyor.
...
src_payload:
  ...
  - 'SURVEYORTYPE'
src_hashdiff: 'HASHDIFF_AUG_LNK_ROLE_SURVEYOR'
