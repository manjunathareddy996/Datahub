...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_GROUP_SCHEME, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_group_scheme; Maximus-only augmented table.
...
src_payload:
  - 'GROUPBUFFERAMOUNT'
  - 'GROUPHEALTHUSERTYPE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_GROUP_SCHEME'
