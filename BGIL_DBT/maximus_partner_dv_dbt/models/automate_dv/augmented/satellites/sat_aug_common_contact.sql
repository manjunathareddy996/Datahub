...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_COMMON_CONTACT, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_common_contact; Maximus-only augmented table.
...
src_payload:
  ...
  - 'WEBSITEURL'
src_hashdiff: 'HASHDIFF_AUG_COMMON_CONTACT'
