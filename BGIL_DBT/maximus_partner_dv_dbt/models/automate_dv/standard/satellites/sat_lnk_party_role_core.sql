...
{%- set yaml_metadata -%}
source_model:
  - 'stg2_mp_up__pd_prop_msdp_pv__lnk_party_role_core'
  - 'stg2_mp_up__pd_prop_sp_pv__lnk_party_role_core'
  - 'stg2_mp_up__pd_rel__lnk_party_role_core'
  - 'stg2_mp_up__pd_relparty__lnk_party_role_core'
src_pk: 'PARTY_HKEY'
src_cdk:
  - 'ROLECODE'
  - 'ROLESEQUENCE'
