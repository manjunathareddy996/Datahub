...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_PROVIDER_CAPABILITY, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_provider_capability; Maximus-only augmented table.
...
src_payload:
  - 'DEDICATEDCAPACITY'
  - 'YEAROFPURCHASE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_PROVIDER_CAPABILITY'
