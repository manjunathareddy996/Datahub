...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_COMMON_ADMIN_GEOGRAPHY, at HUB_LOCATION grain.
-- partner_dv_dbt does not build sat_aug_common_admin_geography; Maximus-only augmented table.
...
{%- set yaml_metadata -%}
source_model:
  - 'stg2_aug_mp__pd_prop_sp_pv__location'
src_pk: 'LOCATION_HKEY'
src_payload:
  - 'UNIONTERRITORYINDICATOR'
src_hashdiff: 'HASHDIFF_AUG_COMMON_ADMIN_GEOGRAPHY'
