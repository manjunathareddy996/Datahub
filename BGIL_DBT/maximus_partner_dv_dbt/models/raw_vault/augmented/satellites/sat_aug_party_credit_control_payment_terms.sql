...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_CREDIT_CONTROL_PAYMENT_TERMS, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_credit_control_payment_terms; Maximus-only augmented table.
...
src_hashdiff: 'HASHDIFF_AUG_PARTY_CREDIT_CONTROL_PAYMENT_TERMS'
