...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_SUSPENSION_NEGATIVE_ACTION, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_suspension_negative_action; Maximus-only augmented table.
...
src_payload:
  ...
  - 'SUSPENSIONINDICATOR'
  - 'SUSPENSIONREASON'
src_hashdiff: 'HASHDIFF_AUG_PARTY_SUSPENSION_NEGATIVE_ACTION'
