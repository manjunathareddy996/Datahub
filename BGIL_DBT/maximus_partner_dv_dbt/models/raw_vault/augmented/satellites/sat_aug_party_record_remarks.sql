...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_RECORD_REMARKS, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_record_remarks; Maximus-only augmented table.
...
src_payload:
  ...
  - 'SPECIALREMARKS'
  - 'TEAMLEADERREMARK'
src_hashdiff: 'HASHDIFF_AUG_PARTY_RECORD_REMARKS'
