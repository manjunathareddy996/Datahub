...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_SOURCE_PROPERTY_SET_RECORD_GOVERNANCE, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_source_property_set_record_governance; Maximus-only augmented table.
...
src_payload:
  ...
  - 'PROPERTYSETREMARKS'
  - 'PROPERTYSTARTDATE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_SOURCE_PROPERTY_SET_RECORD_GOVERNANCE'
