...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_COMMON_CLASSIFICATION, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_common_classification; Maximus-only augmented table.
...
src_payload:
  ...
  - 'PRIVEFLAG'
  - 'PROFILECODE'
src_hashdiff: 'HASHDIFF_AUG_COMMON_CLASSIFICATION'
