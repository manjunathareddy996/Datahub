...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_CLAIM_HISTORY, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_claim_history; Maximus-only augmented table.
...
src_payload:
  - 'CLAIMREMARKS'
src_hashdiff: 'HASHDIFF_AUG_PARTY_CLAIM_HISTORY'
