...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PROVIDER_QUALITY, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_provider_quality; Maximus-only augmented table.
...
src_payload:
  ...
  - 'SITEVISITDATE'
src_hashdiff: 'HASHDIFF_AUG_PROVIDER_QUALITY'
