...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_COMMON_GEO, at HUB_LOCATION grain.
-- partner_dv_dbt does not build sat_aug_common_geo; Maximus-only augmented table.
...
src_payload:
  - 'ALTITUDE'
src_hashdiff: 'HASHDIFF_AUG_COMMON_GEO'
