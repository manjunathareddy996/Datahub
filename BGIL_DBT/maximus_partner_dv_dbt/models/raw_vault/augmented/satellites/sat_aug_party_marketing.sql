...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_MARKETING, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_marketing; Maximus-only augmented table.
...
src_payload:
  ...
  - 'COUPONREBATEVALUE'
  - 'COUPONTYPE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_MARKETING'
