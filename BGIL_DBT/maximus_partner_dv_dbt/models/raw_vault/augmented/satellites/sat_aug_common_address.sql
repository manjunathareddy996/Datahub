...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_COMMON_ADDRESS, at HUB_LOCATION grain.
-- partner_dv_dbt does not build sat_aug_common_address; Maximus-only augmented table.
...
src_payload:
  - 'FULLADDRESSTEXT'
src_hashdiff: 'HASHDIFF_AUG_COMMON_ADDRESS'
