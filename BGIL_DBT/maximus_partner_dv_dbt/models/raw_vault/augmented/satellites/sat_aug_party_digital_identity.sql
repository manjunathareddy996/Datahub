...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_PARTY_DIGITAL_IDENTITY, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_party_digital_identity; Maximus-only augmented table.
...
src_payload:
  ...
  - 'PORTALACCESSSTATUS'
  - 'USERTYPE'
src_hashdiff: 'HASHDIFF_AUG_PARTY_DIGITAL_IDENTITY'
