...
-- MAXIMUS PARTNER AUGMENTED (unconfirmed) sat() for SAT_AUG_LNK_PARTY_ROLE_CORE, at HUB_PARTY grain.
-- partner_dv_dbt does not build sat_aug_lnk_party_role_core; Maximus-only augmented table.
...
src_hashdiff: 'HASHDIFF_AUG_LNK_PARTY_ROLE_CORE'
