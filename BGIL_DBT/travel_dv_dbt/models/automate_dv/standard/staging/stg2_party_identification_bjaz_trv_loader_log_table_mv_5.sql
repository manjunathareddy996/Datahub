...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_PARTY_IDENTIFICATION, table 'BJAZ_TRV_LOADER_LOG_TABLE_MV', column 'PASSPORTNO' -> Passport Number [{'IDENTIFICATION_TYPE_CODE': 'passport'}].
