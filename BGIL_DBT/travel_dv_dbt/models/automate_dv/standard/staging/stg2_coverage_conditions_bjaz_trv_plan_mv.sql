...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_COVERAGE_CONDITIONS, table 'BJAZ_TRV_PLAN_MV'.
...
derived_columns:
  ...
  CONDITION_DESCRIPTION: 'claim_cover_desc'
  WAITING_PERIOD_CONDITION: 'deductable_time'
