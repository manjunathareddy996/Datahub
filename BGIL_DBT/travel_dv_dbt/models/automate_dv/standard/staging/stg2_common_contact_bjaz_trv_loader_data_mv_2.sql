...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_COMMON_CONTACT, table 'BJAZ_TRV_LOADER_DATA_MV', column 'FAX' -> Fax Number [{'CONTACT_POINT_TYPE': 'fax', 'CONTACT_PRIORITY_ORDER': '1'}].
