...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_RISK_PERSON_INSURED, table 'BJAZ_TRV_LOADER_DATA_MV', traveller MEMBER1.
...
derived_columns:
  ...
  PRE_EXISTING_DISEASE_DESCRIPTION: 'member1desease'
