...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_POLICY_CLASSIFICATION, table 'BJAZ_TRV_LOADER_LOG_TABLE_MV', column 'FAMILYFLAG' -> Classification Value [{'CLASSIFICATION_TYPE': 'family_plan'}].
