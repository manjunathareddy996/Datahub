...
-- branch 'HOMEBURGLARYINSURANCE' on 'BJAZ_TRV_LOADER_DATA_MV'. Reuses the exact COVERAGE_HKEY
-- formula from stg2_hub_bjaz_trv_loader_data_mv__coverage_homeburglaryinsurance.sql.

-- Cover Code: TRV_HOME_BURGLARY (Home Burglary Insurance) -- from the mapper's Benefit Catalog sheet (round 3).
