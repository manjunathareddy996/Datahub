...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_FINTXN_HEADER, table
...
-- at all on this table. Only contributing table/column for this satellite in this LOB.
