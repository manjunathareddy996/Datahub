...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_COMMON_CONTACT, table 'BJAZ_TRV_LOADER_LOG_TABLE_MV', column 'EMAIL' -> Email Address [{'CONTACT_POINT_TYPE': 'email', 'CONTACT_PRIORITY_ORDER': '1'}].
