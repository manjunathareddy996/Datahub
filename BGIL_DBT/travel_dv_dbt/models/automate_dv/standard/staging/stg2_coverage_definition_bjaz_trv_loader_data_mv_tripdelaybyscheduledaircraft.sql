...
-- branch 'TRIPDELAYBYSCHEDULEDAIRCRAFT' on 'BJAZ_TRV_LOADER_DATA_MV'. Reuses the exact COVERAGE_HKEY
-- formula from stg2_hub_bjaz_trv_loader_data_mv__coverage_tripdelaybyscheduledaircraft.sql.
...
derived_columns:
  ...
  FREE_COVER_LIMIT: 'tripdelaybyscheduledaircraft'
