...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_COMMON_CONTACT, table 'BJAZ_TRV_LOADER_LOG_TABLE_MV', column 'TELEPHONE' -> Landline Number [{'CONTACT_POINT_TYPE': 'landline', 'CONTACT_PRIORITY_ORDER': '1'}].
