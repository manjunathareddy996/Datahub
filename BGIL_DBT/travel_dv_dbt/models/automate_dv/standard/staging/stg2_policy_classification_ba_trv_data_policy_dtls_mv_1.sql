...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_POLICY_CLASSIFICATION, table 'BA_TRV_DATA_POLICY_DTLS_MV', column 'FAMILY_FLAG' -> Classification Value [{'CLASSIFICATION_TYPE': 'family_plan'}].
