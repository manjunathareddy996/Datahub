...
-- TRAVEL STANDARD-MODEL per-table stage() for SAT_PRODUCT_RATING_FACTOR, table 'BJAZ_TRV_RATE_MASTER_MV', column 'DAYS_TO' -> Value Range To [{'ACTIVE_SEQUENCE_NUMBER': 'days_band'}].
