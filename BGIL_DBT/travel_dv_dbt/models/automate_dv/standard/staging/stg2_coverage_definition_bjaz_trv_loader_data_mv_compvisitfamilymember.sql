...
-- branch 'COMPVISITFAMILYMEMBER' on 'BJAZ_TRV_LOADER_DATA_MV'. Reuses the exact COVERAGE_HKEY
-- formula from stg2_hub_bjaz_trv_loader_data_mv__coverage_compvisitfamilymember.sql.

-- Cover Code: TRV_COMPASSIONATE_VISIT (Compassionate Visit By Family Member) -- from the mapper's Benefit Catalog sheet (round 3).
