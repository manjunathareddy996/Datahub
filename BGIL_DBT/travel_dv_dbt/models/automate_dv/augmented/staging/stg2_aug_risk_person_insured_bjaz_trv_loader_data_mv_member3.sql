...
-- table 'BJAZ_TRV_LOADER_DATA_MV', traveller MEMBER3. Reuses the same
-- POLICY_REF || '|MEMBER3' composite as the standard-model risk-object build.
