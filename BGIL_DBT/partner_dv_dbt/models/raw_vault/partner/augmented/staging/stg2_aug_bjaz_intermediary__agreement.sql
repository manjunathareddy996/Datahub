...
-- PARTNER AUGMENTED (unconfirmed) per-table stage() for HUB_AGREEMENT, table 'BJAZ_INTERMEDIARY'.
...
-- verified HUB_AGREEMENT key, so the key itself is genuine; the attribute proposal is not
...
derived_columns:
  ...
  AGREEMENT_NATURE_OTHER_DETAIL: 'nature_of_agreement_other'
