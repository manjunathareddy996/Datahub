...
-- PARTNER AUGMENTED (unconfirmed) per-table stage() for HUB_POLICY, table 'BJAZ_SH_MEM_DTLS_EXTN'.
-- 1 previously-unmapped column(s), per the modeler's own
-- Augmentation sheet -- NOT yet formally added to data_5a.js. BJAZ_SH_MEM_DTLS_EXTN carries a
...
derived_columns:
  ...
  RECORD_SOURCE: '!OPUS_BJAZ_SH_MEM_DTLS_EXTN'
{%- endset -%}
