...
-- PARTNER AUGMENTED (unconfirmed) per-table stage() for HUB_LOCATION, table 'CP_ADDRESSES'.
-- 2 previously-unmapped column(s), per the modeler's own
-- Augmentation sheet -- NOT yet formally added to data_5a.js. CP_ADDRESSES carries a
...
{%- set yaml_metadata -%}
source_model: 'stg_partner__cp_addresses'
hashed_columns:
...
derived_columns:
  ...
  RECORD_SOURCE: '!OPUS_CP_ADDRESSES'
{%- endset -%}
