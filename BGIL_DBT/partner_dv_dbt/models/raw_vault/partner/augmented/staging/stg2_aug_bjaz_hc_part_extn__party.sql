...
-- PARTNER AUGMENTED (unconfirmed) per-table stage() for HUB_PARTY, table 'BJAZ_HC_PART_EXTN'.
-- 1 previously-unmapped column(s), per the modeler's own
-- Augmentation sheet -- NOT yet formally added to data_5a.js. BJAZ_HC_PART_EXTN carries a
...
derived_columns:
  ...
  RECORD_SOURCE: '!OPUS_BJAZ_HC_PART_EXTN'
{%- endset -%}
