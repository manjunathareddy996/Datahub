...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_ASSESSMENT, table 'BJAZ_HM_DOCTOR_MULTI_ASSESS'.
-- 2 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BJAZ_HM_DOCTOR_MULTI_ASSESS carries a verified HUB_ASSESSMENT key
