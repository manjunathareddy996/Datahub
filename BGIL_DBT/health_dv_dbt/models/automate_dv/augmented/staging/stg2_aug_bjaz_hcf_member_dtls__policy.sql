...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_POLICY, table 'BJAZ_HCF_MEMBER_DTLS'.
-- 1 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BJAZ_HCF_MEMBER_DTLS carries a verified HUB_POLICY key
...
derived_columns:
  ...
  PREV_POLICY_SINCE: 'prev_policy_since'
