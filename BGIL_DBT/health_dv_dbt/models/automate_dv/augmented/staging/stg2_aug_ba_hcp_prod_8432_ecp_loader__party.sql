...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_PARTY, table 'BA_HCP_PROD_8432_ECP_LOADER'.
-- 1 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BA_HCP_PROD_8432_ECP_LOADER carries a verified HUB_PARTY key
