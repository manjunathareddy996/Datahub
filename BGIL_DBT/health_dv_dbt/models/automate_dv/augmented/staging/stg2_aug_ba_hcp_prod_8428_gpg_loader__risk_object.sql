...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_RISK_OBJECT, table 'BA_HCP_PROD_8428_GPG_LOADER'.
-- 1 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BA_HCP_PROD_8428_GPG_LOADER carries a verified HUB_RISK_OBJECT key
