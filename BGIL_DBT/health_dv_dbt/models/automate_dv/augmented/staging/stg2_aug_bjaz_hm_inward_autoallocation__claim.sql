...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_CLAIM, table 'BJAZ_HM_INWARD_AUTOALLOCATION'.
-- 1 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BJAZ_HM_INWARD_AUTOALLOCATION carries a verified HUB_CLAIM key
