...
-- STANDARD-MODEL per-table stage() for HUB_AGREEMENT branch 'BJAZ_HEALTH_WEBSERVICE_INFO'.
-- Not covered by a stitch for this hub -- AGREEMENT_HKEY hashed directly here,
-- namespaced ('HUB_AGREEMENT|' || raw key), same convention as every other hkey
...
derived_columns:
  PARENT_BK: 'deal_id'
  AGREEMENT_NK: "'HUB_AGREEMENT|' || deal_id"
