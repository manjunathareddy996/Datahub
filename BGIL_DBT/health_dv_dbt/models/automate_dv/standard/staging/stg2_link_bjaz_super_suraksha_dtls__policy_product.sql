...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_super_suraksha_dtls'.
...
derived_columns:
  ...
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || contract_id || '|' || product_code"
