...
-- STANDARD-MODEL per-table stage() for LNK_ASSESSMENT_PARTY member-end 'ba_hcp_pp_mem_dtls'.
...
derived_columns:
  ...
  ASSESSMENT_PARTY_HKEY_NK: "'LNK_ASSESSMENT_PARTY|' || scrutiny_no || '|' || alloted_to"
