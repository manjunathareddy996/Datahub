...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_PRODUCT member-end 'bjaz_gp_hospital_cash'.
...
derived_columns:
  ...
  PROPOSAL_PRODUCT_HKEY_NK: "'LNK_PROPOSAL_PRODUCT|' || product_code || '|' || kgc_proposal_number"
