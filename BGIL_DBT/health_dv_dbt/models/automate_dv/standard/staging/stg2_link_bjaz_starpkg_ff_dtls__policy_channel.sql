...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_starpkg_ff_dtls'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_starpkg_ff_dtls'
hashed_columns:
...
derived_columns:
  ...
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || partner_id || '|' || contract_id"
