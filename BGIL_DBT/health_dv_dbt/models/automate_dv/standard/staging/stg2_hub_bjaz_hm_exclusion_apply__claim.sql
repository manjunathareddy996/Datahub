...
-- STANDARD-MODEL per-table stage() for HUB_CLAIM branch 'BJAZ_HM_EXCLUSION_APPLY'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_hm_exclusion_apply'
hashed_columns:
  CLAIM_HKEY: 'CLAIM_NK'
derived_columns:
  PARENT_BK: 'claim_id'
  ...
  RECORD_SOURCE: '!BJAZ_HM_EXCLUSION_APPLY'
{%- endset -%}
