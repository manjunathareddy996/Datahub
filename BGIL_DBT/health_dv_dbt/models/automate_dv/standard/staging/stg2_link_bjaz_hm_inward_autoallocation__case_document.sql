...
-- STANDARD-MODEL per-table stage() for LNK_CASE_DOCUMENT member-end 'bjaz_hm_inward_autoallocation'.
...
derived_columns:
  ...
  CASE_DOCUMENT_HKEY_NK: "'LNK_CASE_DOCUMENT|' || allocate_id || '|' || omni_inward_no"
