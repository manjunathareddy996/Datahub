...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PARTY member-end 'bjaz_grp_tpa_extn'.
...
derived_columns:
  PARTY_HKEY_NK: "'HUB_PARTY|' || tpa_code"
  POLICY_HKEY_NK: "'HUB_POLICY|' || contract_id"
  POLICY_PARTY_HKEY_NK: "'LNK_POLICY_PARTY|' || tpa_code || '|' || contract_id"
