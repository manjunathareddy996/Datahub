...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'bjaz_pnb_gpa_data'.
...
derived_columns:
  ...
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || locationcode || '|' || master_policy_no"
