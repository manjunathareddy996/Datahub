...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_DOCUMENT member-end 'bjaz_hm_inward_dtls'.
...
derived_columns:
  ...
  PARTY_HKEY_NK: "'HUB_PARTY|' || courier_id"
  PARTY_DOCUMENT_HKEY_NK: "'LNK_PARTY_DOCUMENT|' || inward_id || '|' || courier_id"
