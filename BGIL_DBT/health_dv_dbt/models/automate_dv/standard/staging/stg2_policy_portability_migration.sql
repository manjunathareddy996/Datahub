...
-- STANDARD-MODEL stage() pass for stitch_policy_portability_migration -- serves SAT_POLICY_PORTABILITY_MIGRATION.
...
{%- set yaml_metadata -%}
source_model: 'stitch_policy_portability_migration'
hashed_columns:
