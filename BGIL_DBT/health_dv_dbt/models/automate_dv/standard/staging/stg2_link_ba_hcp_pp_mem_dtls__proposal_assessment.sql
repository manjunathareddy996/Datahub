...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_ASSESSMENT member-end 'ba_hcp_pp_mem_dtls'.
...
derived_columns:
  ...
  PROPOSAL_ASSESSMENT_HKEY_NK: "'LNK_PROPOSAL_ASSESSMENT|' || scrutiny_no || '|' || hi_control_number"
