...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_POLICY member-end 'bjaz_gg_prem_dtls'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_gg_prem_dtls'
hashed_columns:
...
derived_columns:
  ...
  PROPOSAL_POLICY_HKEY_NK: "'LNK_PROPOSAL_POLICY|' || master_policy_no || '|' || ba_lead_no"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_GG_PREM_DTLS'
{%- endset -%}
