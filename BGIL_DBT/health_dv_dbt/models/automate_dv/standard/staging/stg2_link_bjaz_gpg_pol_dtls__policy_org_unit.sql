...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_ORG_UNIT member-end 'bjaz_gpg_pol_dtls'.
...
derived_columns:
  ...
  POLICY_ORG_UNIT_HKEY_NK: "'LNK_POLICY_ORG_UNIT|' || company_org_unit || '|' || reference_id"
