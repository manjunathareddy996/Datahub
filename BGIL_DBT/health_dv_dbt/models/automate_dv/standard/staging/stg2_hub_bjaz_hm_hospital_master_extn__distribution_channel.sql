...
-- STANDARD-MODEL per-table stage() for HUB_DISTRIBUTION_CHANNEL branch 'BJAZ_HM_HOSPITAL_MASTER_EXTN'.
...
derived_columns:
  PARENT_BK: 'distribution_partner'
  DISTRIBUTION_CHANNEL_NK: "'HUB_DISTRIBUTION_CHANNEL|' || distribution_partner"
