...
-- STANDARD-MODEL per-table stage() for LNK_AGREEMENT_PARTY member-end 'bjaz_remedinet_claim_details'.
...
derived_columns:
  ...
  AGREEMENT_PARTY_HKEY_NK: "'LNK_AGREEMENT_PARTY|' || remedinet_provider_code || '|' || payer_code"
