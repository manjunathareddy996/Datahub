...
-- STANDARD-MODEL per-table stage() for SAT_PARTY_IDENTIFICATION, table 'BA_HCP_PROD_8428_GPG_LOADER' (union branch, no attribute-level merge needed).
...
derived_columns:
  ...
  AADHAAR_NUMBER: 'pd_adhar_card_no'
  EIA_NUMBER: 'pd_electronic_insur_account_no'
  GSTIN: 'gstin_uin'
  IDENTIFICATION_NUMBER: 'pd_bank_ref_no2_bank_cust_id'
