...
-- STANDARD-MODEL per-table stage() for HUB_DISTRIBUTION_CHANNEL branch 'BJAZ_HM_CLM_REGISTER'.
...
derived_columns:
  PARENT_BK: 'main_agent_code'
  DISTRIBUTION_CHANNEL_NK: "'HUB_DISTRIBUTION_CHANNEL|' || main_agent_code"
