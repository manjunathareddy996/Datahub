...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_ORG_UNIT member-end 'bjaz_health_webservice_info'.
...
derived_columns:
  ...
  POLICY_ORG_UNIT_HKEY_NK: "'LNK_POLICY_ORG_UNIT|' || dept_code || '|' || policy_ref"
