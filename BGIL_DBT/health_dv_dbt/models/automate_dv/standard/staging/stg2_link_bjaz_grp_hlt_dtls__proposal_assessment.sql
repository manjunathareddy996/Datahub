...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_ASSESSMENT member-end 'bjaz_grp_hlt_dtls'.
...
derived_columns:
  ...
  PROPOSAL_ASSESSMENT_HKEY_NK: "'LNK_PROPOSAL_ASSESSMENT|' || scrutiny_no || '|' || quote_ref_no"
