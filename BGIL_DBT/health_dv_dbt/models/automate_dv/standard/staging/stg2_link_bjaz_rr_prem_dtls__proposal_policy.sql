...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_POLICY member-end 'bjaz_rr_prem_dtls'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_rr_prem_dtls'
hashed_columns:
...
derived_columns:
  ...
  RECORD_SOURCE: '!BJAZ_RR_PREM_DTLS'
{%- endset -%}
