...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_PARTY member-end 'bjaz_hdfc_sec_fhpp'.
...
derived_columns:
  PARTY_HKEY_NK: "'HUB_PARTY|' || client_id"
  PROPOSAL_HKEY_NK: "'HUB_PROPOSAL|' || ba_lead_no"
  PROPOSAL_PARTY_HKEY_NK: "'LNK_PROPOSAL_PARTY|' || client_id || '|' || ba_lead_no"
