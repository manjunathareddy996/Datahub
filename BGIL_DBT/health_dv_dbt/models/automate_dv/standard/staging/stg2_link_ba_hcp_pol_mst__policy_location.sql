...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'ba_hcp_pol_mst'.
...
derived_columns:
  ...
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || child_loc_code || '|' || contract_id"
