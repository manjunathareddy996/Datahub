...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_tpa_claim_details_ws'.
...
derived_columns:
  ...
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || partner_id || '|' || policy_no"
