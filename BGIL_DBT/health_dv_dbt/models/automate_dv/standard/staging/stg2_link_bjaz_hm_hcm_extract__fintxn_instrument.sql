...
-- STANDARD-MODEL per-table stage() for LNK_FINTXN_INSTRUMENT member-end 'bjaz_hm_hcm_extract'.
...
derived_columns:
  ...
  FINTXN_INSTRUMENT_HKEY_NK: "'LNK_FINTXN_INSTRUMENT|' || utr_no || '|' || cheque_no"
