...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_ORG_UNIT member-end 'bjaz_grp_hlt_dtls'.
...
derived_columns:
  ORG_UNIT_HKEY_NK: "'HUB_ORG_UNIT|' || branch"
  POLICY_HKEY_NK: "'HUB_POLICY|' || reg_no"
  POLICY_ORG_UNIT_HKEY_NK: "'LNK_POLICY_ORG_UNIT|' || branch || '|' || reg_no"
