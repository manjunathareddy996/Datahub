...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_hdfc_sec_fhpp'.
...
derived_columns:
  ...
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || reference_id || '|' || product_code"
