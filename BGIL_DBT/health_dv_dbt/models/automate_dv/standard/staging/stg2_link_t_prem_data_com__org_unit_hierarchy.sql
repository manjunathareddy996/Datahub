...
-- STANDARD-MODEL per-table stage() for LNK_ORG_UNIT_HIERARCHY member-end 't_prem_data_com'.
...
derived_columns:
  ORG_UNIT_FROM_HKEY_NK: "'HUB_ORG_UNIT|' || branch_code"
  ORG_UNIT_TO_HKEY_NK: "'HUB_ORG_UNIT|' || department_code"
  ORG_UNIT_HIERARCHY_HKEY_NK: "'LNK_ORG_UNIT_HIERARCHY|' || branch_code || '|' || department_code"
