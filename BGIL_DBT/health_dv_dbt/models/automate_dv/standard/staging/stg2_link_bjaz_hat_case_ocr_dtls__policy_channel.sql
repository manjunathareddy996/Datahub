...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_hat_case_ocr_dtls'.
...
derived_columns:
  ...
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || imd_code || '|' || policy_number"
