...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_grp_hlt_cust_dtls'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_grp_hlt_cust_dtls'
hashed_columns:
...
derived_columns:
  ...
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || reg_no || '|' || product"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_GRP_HLT_CUST_DTLS'
{%- endset -%}
