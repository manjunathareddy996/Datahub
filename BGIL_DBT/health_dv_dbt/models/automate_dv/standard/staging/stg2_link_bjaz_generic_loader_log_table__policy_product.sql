...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_generic_loader_log_table'.
...
derived_columns:
  ...
  PRODUCT_HKEY_NK: "'HUB_PRODUCT|' || schemecode"
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || pmasterpolicynumber || '|' || schemecode"
