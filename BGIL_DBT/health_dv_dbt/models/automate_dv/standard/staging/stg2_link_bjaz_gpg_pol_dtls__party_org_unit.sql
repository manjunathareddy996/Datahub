...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_ORG_UNIT member-end 'bjaz_gpg_pol_dtls'.
...
derived_columns:
  ...
  PARTY_ORG_UNIT_HKEY_NK: "'LNK_PARTY_ORG_UNIT|' || company_org_unit || '|' || bagic_e_code"
