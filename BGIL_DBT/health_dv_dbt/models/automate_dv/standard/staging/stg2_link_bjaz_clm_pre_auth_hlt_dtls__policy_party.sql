...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PARTY member-end 'bjaz_clm_pre_auth_hlt_dtls'.
...
derived_columns:
  ...
  POLICY_PARTY_HKEY_NK: "'LNK_POLICY_PARTY|' || hospital_id || '|' || contract_id"
