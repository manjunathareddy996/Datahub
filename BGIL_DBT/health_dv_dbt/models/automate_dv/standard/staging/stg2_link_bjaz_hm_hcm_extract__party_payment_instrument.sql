...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_PAYMENT_INSTRUMENT member-end 'bjaz_hm_hcm_extract'.
...
derived_columns:
  ...
  PARTY_PAYMENT_INSTRUMENT_HKEY_NK: "'LNK_PARTY_PAYMENT_INSTRUMENT|' || hospital_id || '|' || cheque_no"
