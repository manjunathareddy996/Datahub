...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_DOCUMENT member-end 'bjaz_ihg_mem_dtls_extn'.
...
derived_columns:
  ...
  POLICY_DOCUMENT_HKEY_NK: "'LNK_POLICY_DOCUMENT|' || medical_report || '|' || contract_id"
