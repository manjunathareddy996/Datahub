...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_LOCATION member-end 'bjaz_gc_group_guard_dtls'.
...
derived_columns:
  ...
  PARTY_LOCATION_HKEY_NK: "'LNK_PARTY_LOCATION|' || location_code || '|' || user_id"
