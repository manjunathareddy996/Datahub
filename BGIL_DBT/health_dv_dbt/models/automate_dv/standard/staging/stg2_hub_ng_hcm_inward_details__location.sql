...
-- STANDARD-MODEL per-table stage() for HUB_LOCATION branch 'NG_HCM_INWARD_DETAILS'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__ng_hcm_inward_details'
hashed_columns:
  LOCATION_HKEY: 'LOCATION_NK'
derived_columns:
  PARENT_BK: 'locationcode'
  LOCATION_NK: "'HUB_LOCATION|' || locationcode"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!NG_HCM_INWARD_DETAILS'
{%- endset -%}
