...
-- STANDARD-MODEL per-table stage() for HUB_POLICY branch 'BJAZ_WS_FAMILY_DTLS_BANDHAN'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_ws_family_dtls_bandhan'
hashed_columns:
  POLICY_HKEY: 'POLICY_NK'
derived_columns:
  PARENT_BK: 'pmasterpolicynumber'
  POLICY_NK: "'HUB_POLICY|' || pmasterpolicynumber"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_WS_FAMILY_DTLS_BANDHAN'
{%- endset -%}
