...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_DOCUMENT member-end 'bjaz_hm_clm_register'.
...
derived_columns:
  ...
  POLICY_DOCUMENT_HKEY_NK: "'LNK_POLICY_DOCUMENT|' || inward_id || '|' || contract_id"
