...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_DOCUMENT member-end 'bjaz_ihg_mem_dtls_extn'.
...
derived_columns:
  ...
  PARTY_DOCUMENT_HKEY_NK: "'LNK_PARTY_DOCUMENT|' || medical_report || '|' || member_no"
