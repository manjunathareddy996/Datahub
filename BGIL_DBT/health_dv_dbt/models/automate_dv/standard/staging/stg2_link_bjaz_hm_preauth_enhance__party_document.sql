...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_DOCUMENT member-end 'bjaz_hm_preauth_enhance'.
...
derived_columns:
  ...
  PARTY_DOCUMENT_HKEY_NK: "'LNK_PARTY_DOCUMENT|' || omni_inward_no || '|' || hosp_id"
