...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_ehh_pol_dtls'.
...
derived_columns:
  ...
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || policy_ref || '|' || product_4digit_code"
