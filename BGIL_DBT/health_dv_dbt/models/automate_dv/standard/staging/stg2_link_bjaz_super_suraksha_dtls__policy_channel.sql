...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_super_suraksha_dtls'.
...
derived_columns:
  ...
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || imd_code || '|' || contract_id"
