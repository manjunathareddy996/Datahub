...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_DOCUMENT member-end 'bjaz_remedinet_claim_details'.
...
derived_columns:
  ...
  POLICY_DOCUMENT_HKEY_NK: "'LNK_POLICY_DOCUMENT|' || omni_inward_no || '|' || policy_no"
