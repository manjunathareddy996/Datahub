...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_CHANNEL member-end 'bjaz_pc_online_pol_dtls_mv'.
...
derived_columns:
  ...
  PARTY_CHANNEL_HKEY_NK: "'LNK_PARTY_CHANNEL|' || main_agent_code || '|' || part_id"
