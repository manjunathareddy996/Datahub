...
-- STANDARD-MODEL per-table stage() for LNK_RISK_OBJECT_PARTY member-end 'bjaz_ec_mem_dtls_extn'.
...
derived_columns:
  ...
  RISK_OBJECT_PARTY_HKEY_NK: "'LNK_RISK_OBJECT_PARTY|' || member_no || '|' || member_no"
