...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_DOCUMENT member-end 'bjaz_card_dtls'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_card_dtls'
hashed_columns:
...
derived_columns:
  ...
  POLICY_DOCUMENT_HKEY_NK: "'LNK_POLICY_DOCUMENT|' || card_no || '|' || policy_ref"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_CARD_DTLS'
{%- endset -%}
