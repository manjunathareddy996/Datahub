...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_PARTY member-end 'bjaz_gp_hospital_cash'.
...
derived_columns:
  ...
  PROPOSAL_PARTY_HKEY_NK: "'LNK_PROPOSAL_PARTY|' || user_id || '|' || kgc_proposal_number"
