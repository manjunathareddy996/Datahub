...
-- STANDARD-MODEL per-table stage() for LNK_CLAIM_LOCATION member-end 'bjaz_bandhan_medi_clam'.
...
derived_columns:
  ...
  CLAIM_LOCATION_HKEY_NK: "'LNK_CLAIM_LOCATION|' || reference_id || '|' || location_code"
