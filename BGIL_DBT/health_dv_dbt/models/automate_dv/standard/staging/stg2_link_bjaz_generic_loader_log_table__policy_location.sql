...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'bjaz_generic_loader_log_table'.
...
derived_columns:
  LOCATION_HKEY_NK: "'HUB_LOCATION|' || locationcode"
  POLICY_HKEY_NK: "'HUB_POLICY|' || pmasterpolicynumber"
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || locationcode || '|' || pmasterpolicynumber"
