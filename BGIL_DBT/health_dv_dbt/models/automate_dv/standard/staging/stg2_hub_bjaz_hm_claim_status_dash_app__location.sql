...
-- STANDARD-MODEL per-table stage() for HUB_LOCATION branch 'BJAZ_HM_CLAIM_STATUS_DASH_APP'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_hm_claim_status_dash_app'
hashed_columns:
  LOCATION_HKEY: 'LOCATION_NK'
derived_columns:
  PARENT_BK: 'loc_code'
  LOCATION_NK: "'HUB_LOCATION|' || loc_code"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_HM_CLAIM_STATUS_DASH_APP'
{%- endset -%}
