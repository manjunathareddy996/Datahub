...
-- STANDARD-MODEL per-table stage() for LNK_PRODUCT_VARIANT member-end 'bjaz_generic_loader_log_table'.
...
derived_columns:
  PRODUCT_FROM_HKEY_NK: "'HUB_PRODUCT|' || schemecode"
  PRODUCT_TO_HKEY_NK: "'HUB_PRODUCT|' || planid"
  PRODUCT_VARIANT_HKEY_NK: "'LNK_PRODUCT_VARIANT|' || schemecode || '|' || planid"
