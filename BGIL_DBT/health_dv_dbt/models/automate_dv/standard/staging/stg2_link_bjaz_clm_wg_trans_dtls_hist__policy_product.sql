...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_clm_wg_trans_dtls_hist'.
...
derived_columns:
  ...
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || policy_ref || '|' || product_code"
