...
-- STANDARD-MODEL per-table stage() for LNK_LOSS_EVENT_LOCATION member-end 'bjaz_hm_hcm_extract'.
...
derived_columns:
  ...
  LOSS_EVENT_HKEY_NK: "'HUB_LOSS_EVENT|' || claim_no"
  LOSS_EVENT_LOCATION_HKEY_NK: "'LNK_LOSS_EVENT_LOCATION|' || policy_location || '|' || claim_no"
