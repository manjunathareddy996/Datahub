...
-- STANDARD-MODEL per-table stage() for LNK_QUOTE_PRODUCT member-end 'bjaz_ewr_pol_dtls'.
...
derived_columns:
  ...
  QUOTE_PRODUCT_HKEY_NK: "'LNK_QUOTE_PRODUCT|' || product_4digit_code || '|' || quote_ref_no"
