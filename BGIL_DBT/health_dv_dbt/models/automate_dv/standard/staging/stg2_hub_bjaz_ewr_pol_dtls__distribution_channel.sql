...
-- STANDARD-MODEL per-table stage() for HUB_DISTRIBUTION_CHANNEL branch 'BJAZ_EWR_POL_DTLS'.
...
derived_columns:
  PARENT_BK: 'business_source'
  DISTRIBUTION_CHANNEL_NK: "'HUB_DISTRIBUTION_CHANNEL|' || business_source"
