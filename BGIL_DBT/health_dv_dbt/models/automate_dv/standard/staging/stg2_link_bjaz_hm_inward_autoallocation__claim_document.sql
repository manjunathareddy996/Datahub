...
-- STANDARD-MODEL per-table stage() for LNK_CLAIM_DOCUMENT member-end 'bjaz_hm_inward_autoallocation'.
...
derived_columns:
  ...
  CLAIM_DOCUMENT_HKEY_NK: "'LNK_CLAIM_DOCUMENT|' || claim_id || '|' || omni_inward_no"
