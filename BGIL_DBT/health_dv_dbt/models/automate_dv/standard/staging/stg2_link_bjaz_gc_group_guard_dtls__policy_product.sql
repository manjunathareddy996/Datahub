...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_gc_group_guard_dtls'.
...
derived_columns:
  ...
  PRODUCT_HKEY_NK: "'HUB_PRODUCT|' || plan_id"
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || policy_ref || '|' || plan_id"
