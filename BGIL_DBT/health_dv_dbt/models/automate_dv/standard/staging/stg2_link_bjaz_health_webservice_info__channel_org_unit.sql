...
-- STANDARD-MODEL per-table stage() for LNK_CHANNEL_ORG_UNIT member-end 'bjaz_health_webservice_info'.
...
derived_columns:
  ...
  ORG_UNIT_HKEY_NK: "'HUB_ORG_UNIT|' || dept_code"
  CHANNEL_ORG_UNIT_HKEY_NK: "'LNK_CHANNEL_ORG_UNIT|' || partner_id || '|' || dept_code"
