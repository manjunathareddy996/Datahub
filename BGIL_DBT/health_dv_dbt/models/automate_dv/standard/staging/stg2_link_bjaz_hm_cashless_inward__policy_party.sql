...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PARTY member-end 'bjaz_hm_cashless_inward'.
...
{%- set yaml_metadata -%}
source_model: 'stg_health__bjaz_hm_cashless_inward'
hashed_columns:
...
derived_columns:
  ...
  POLICY_PARTY_HKEY_NK: "'LNK_POLICY_PARTY|' || hospital_id || '|' || policy_ref"
  LOAD_DATETIME: '!CURRENT_TIMESTAMP()'
  RECORD_SOURCE: '!BJAZ_HM_CASHLESS_INWARD'
{%- endset -%}
