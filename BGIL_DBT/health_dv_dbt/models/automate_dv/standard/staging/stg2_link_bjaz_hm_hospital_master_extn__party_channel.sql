...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_CHANNEL member-end 'bjaz_hm_hospital_master_extn'.
...
derived_columns:
  ...
  PARTY_CHANNEL_HKEY_NK: "'LNK_PARTY_CHANNEL|' || distribution_partner || '|' || hosid"
