...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_CHANNEL member-end 'bjaz_tpa_claim_details_ws'.
...
derived_columns:
  ...
  PARTY_CHANNEL_HKEY_NK: "'LNK_PARTY_CHANNEL|' || partner_id || '|' || customer_id"
