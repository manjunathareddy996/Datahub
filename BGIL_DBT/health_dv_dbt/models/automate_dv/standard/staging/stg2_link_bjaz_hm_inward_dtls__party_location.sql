...
-- STANDARD-MODEL per-table stage() for LNK_PARTY_LOCATION member-end 'bjaz_hm_inward_dtls'.
...
derived_columns:
  ...
  PARTY_LOCATION_HKEY_NK: "'LNK_PARTY_LOCATION|' || location_code || '|' || courier_id"
