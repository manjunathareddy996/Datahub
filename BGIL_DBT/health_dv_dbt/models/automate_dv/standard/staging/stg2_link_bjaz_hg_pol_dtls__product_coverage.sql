...
-- STANDARD-MODEL per-table stage() for LNK_PRODUCT_COVERAGE member-end 'bjaz_hg_pol_dtls'.
...
derived_columns:
  ...
  PRODUCT_COVERAGE_HKEY_NK: "'LNK_PRODUCT_COVERAGE|' || cover_code || '|' || product_4digit_code"
