...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_hm_clm_register'.
...
derived_columns:
  ...
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || main_agent_code || '|' || contract_id"
