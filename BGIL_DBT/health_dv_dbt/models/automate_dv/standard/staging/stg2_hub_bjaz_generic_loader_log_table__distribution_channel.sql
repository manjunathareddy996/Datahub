...
-- STANDARD-MODEL per-table stage() for HUB_DISTRIBUTION_CHANNEL branch 'BJAZ_GENERIC_LOADER_LOG_TABLE'.
...
derived_columns:
  PARENT_BK: 'partnerid'
  DISTRIBUTION_CHANNEL_NK: "'HUB_DISTRIBUTION_CHANNEL|' || partnerid"
