...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_RISK_OBJECT member-end 'bjaz_ec_mem_dtls_extn'.
...
derived_columns:
  ...
  POLICY_RISK_OBJECT_HKEY_NK: "'LNK_POLICY_RISK_OBJECT|' || contract_id || '|' || member_no"
