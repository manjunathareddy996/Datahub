...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'bjaz_ehh_pol_dtls'.
...
derived_columns:
  ...
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || risk_location || '|' || policy_ref"
