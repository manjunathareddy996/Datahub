...
-- STANDARD-MODEL per-table stage() for LNK_CLAIM_PAYMENT_INSTRUMENT member-end 'bjaz_tpa_claim_details_ws'.
...
derived_columns:
  ...
  CLAIM_PAYMENT_INSTRUMENT_HKEY_NK: "'LNK_CLAIM_PAYMENT_INSTRUMENT|' || bjaz_claim_id || '|' || cheque_no"
