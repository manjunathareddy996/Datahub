...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_hm_coinsu_clm_dtls'.
...
derived_columns:
  ...
  PRODUCT_HKEY_NK: "'HUB_PRODUCT|' || prod_cd"
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || policy_ref || '|' || prod_cd"
