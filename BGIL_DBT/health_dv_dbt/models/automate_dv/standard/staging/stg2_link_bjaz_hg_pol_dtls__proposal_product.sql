...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_PRODUCT member-end 'bjaz_hg_pol_dtls'.
...
derived_columns:
  ...
  PROPOSAL_PRODUCT_HKEY_NK: "'LNK_PROPOSAL_PRODUCT|' || product_4digit_code || '|' || quote_ref_no"
