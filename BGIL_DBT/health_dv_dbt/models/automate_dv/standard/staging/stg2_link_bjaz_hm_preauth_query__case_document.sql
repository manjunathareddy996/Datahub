...
-- STANDARD-MODEL per-table stage() for LNK_CASE_DOCUMENT member-end 'bjaz_hm_preauth_query'.
...
derived_columns:
  ...
  CASE_DOCUMENT_HKEY_NK: "'LNK_CASE_DOCUMENT|' || query_ref_id || '|' || omni_inward_no"
