...
-- STANDARD-MODEL per-table stage() for LNK_CHANNEL_ORG_UNIT member-end 'bjaz_ehh_pol_dtls'.
...
derived_columns:
  ...
  CHANNEL_ORG_UNIT_HKEY_NK: "'LNK_CHANNEL_ORG_UNIT|' || partner_id || '|' || company_org_unit"
