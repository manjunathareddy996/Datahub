...
-- STANDARD-MODEL per-table stage() for SAT_COMMON_CONTACT, table 'BJAZ_HM_INWARD_DTLS' (union branch, no attribute-level merge needed).
...
derived_columns:
  ...
  MOBILE_NUMBER: 'caller_contact_no'
