...
-- STANDARD-MODEL per-table stage() for LNK_CHANNEL_ORG_UNIT member-end 'bjaz_gpg_pol_dtls'.
...
derived_columns:
  ...
  CHANNEL_ORG_UNIT_HKEY_NK: "'LNK_CHANNEL_ORG_UNIT|' || imd_code || '|' || company_org_unit"
