...
-- STANDARD-MODEL per-table stage() for LNK_AGREEMENT_CHANNEL member-end 'bjaz_hm_hospital_master'.
...
derived_columns:
  ...
  AGREEMENT_CHANNEL_HKEY_NK: "'LNK_AGREEMENT_CHANNEL|' || hosid || '|' || partner_id"
