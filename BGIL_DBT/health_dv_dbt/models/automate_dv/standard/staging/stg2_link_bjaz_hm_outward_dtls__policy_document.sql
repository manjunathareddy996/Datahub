...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_DOCUMENT member-end 'bjaz_hm_outward_dtls'.
...
derived_columns:
  DOCUMENT_HKEY_NK: "'HUB_DOCUMENT|' || outward_id"
  POLICY_HKEY_NK: "'HUB_POLICY|' || policy_ref"
  POLICY_DOCUMENT_HKEY_NK: "'LNK_POLICY_DOCUMENT|' || outward_id || '|' || policy_ref"
