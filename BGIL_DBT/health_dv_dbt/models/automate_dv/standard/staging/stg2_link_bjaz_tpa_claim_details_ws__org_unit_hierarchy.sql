...
-- STANDARD-MODEL per-table stage() for LNK_ORG_UNIT_HIERARCHY member-end 'bjaz_tpa_claim_details_ws'.
...
derived_columns:
  ORG_UNIT_FROM_HKEY_NK: "'HUB_ORG_UNIT|' || operating_office"
  ORG_UNIT_TO_HKEY_NK: "'HUB_ORG_UNIT|' || controlling_office"
  ORG_UNIT_HIERARCHY_HKEY_NK: "'LNK_ORG_UNIT_HIERARCHY|' || operating_office || '|' || controlling_office"
