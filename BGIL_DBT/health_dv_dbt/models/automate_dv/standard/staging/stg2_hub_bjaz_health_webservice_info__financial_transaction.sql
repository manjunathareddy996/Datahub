...
-- STANDARD-MODEL per-table stage() for HUB_FINANCIAL_TRANSACTION branch 'BJAZ_HEALTH_WEBSERVICE_INFO'.
-- Not covered by a stitch for this hub -- FINANCIAL_TRANSACTION_HKEY hashed directly here,
-- namespaced ('HUB_FINANCIAL_TRANSACTION|' || raw key), same convention as every other hkey
...
derived_columns:
  ...
  FINANCIAL_TRANSACTION_NK: "'HUB_FINANCIAL_TRANSACTION|' || ptransaction_id"
