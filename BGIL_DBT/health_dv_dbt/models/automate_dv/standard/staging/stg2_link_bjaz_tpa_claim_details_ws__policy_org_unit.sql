...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_ORG_UNIT member-end 'bjaz_tpa_claim_details_ws'.
...
derived_columns:
  ...
  POLICY_ORG_UNIT_HKEY_NK: "'LNK_POLICY_ORG_UNIT|' || operating_office || '|' || policy_no"
