...
-- STANDARD-MODEL stage() pass for stitch_lnk_role_nominee_beneficiary -- serves SAT_LNK_ROLE_NOMINEE_BENEFICIARY.
...
{%- set yaml_metadata -%}
source_model: 'stitch_lnk_role_nominee_beneficiary'
hashed_columns:
  PARTY_HKEY: 'PARTY_NK'
  HASHDIFF:
    is_hashdiff: true
