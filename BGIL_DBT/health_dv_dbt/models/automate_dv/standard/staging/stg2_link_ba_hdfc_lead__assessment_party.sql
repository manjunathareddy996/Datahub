...
-- STANDARD-MODEL per-table stage() for LNK_ASSESSMENT_PARTY member-end 'ba_hdfc_lead'.
...
derived_columns:
  ...
  PARTY_HKEY_NK: "'HUB_PARTY|' || prospect_id"
  ASSESSMENT_PARTY_HKEY_NK: "'LNK_ASSESSMENT_PARTY|' || scrutiny_no || '|' || prospect_id"
