...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'bjaz_hm_orphan_reg'.
...
derived_columns:
  LOCATION_HKEY_NK: "'HUB_LOCATION|' || orphan_loc"
  POLICY_HKEY_NK: "'HUB_POLICY|' || policy_number"
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || orphan_loc || '|' || policy_number"
