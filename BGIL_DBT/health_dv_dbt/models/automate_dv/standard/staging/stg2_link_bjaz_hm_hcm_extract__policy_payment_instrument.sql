...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PAYMENT_INSTRUMENT member-end 'bjaz_hm_hcm_extract'.
...
derived_columns:
  ...
  POLICY_PAYMENT_INSTRUMENT_HKEY_NK: "'LNK_POLICY_PAYMENT_INSTRUMENT|' || cheque_no || '|' || policy"
