...
-- STANDARD-MODEL per-table stage() for LNK_CLAIM_PAYMENT_INSTRUMENT member-end 'bjaz_hm_hcm_extract'.
...
derived_columns:
  ...
  CLAIM_PAYMENT_INSTRUMENT_HKEY_NK: "'LNK_CLAIM_PAYMENT_INSTRUMENT|' || clid || '|' || cheque_no"
