...
-- STANDARD-MODEL per-table stage() for LNK_CLAIM_DOCUMENT member-end 'bjaz_remedinet_claim_details'.
...
derived_columns:
  ...
  CLAIM_DOCUMENT_HKEY_NK: "'LNK_CLAIM_DOCUMENT|' || claim_no || '|' || omni_inward_no"
