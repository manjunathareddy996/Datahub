...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_LOCATION member-end 'bjaz_super_suraksha_dtls'.
...
derived_columns:
  ...
  POLICY_LOCATION_HKEY_NK: "'LNK_POLICY_LOCATION|' || location_code || '|' || contract_id"
