...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'ba_hcp_prime_rider_dtls'.
...
derived_columns:
  POLICY_HKEY_NK: "'HUB_POLICY|' || base_policy_ref"
  PRODUCT_HKEY_NK: "'HUB_PRODUCT|' || product_code"
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || base_policy_ref || '|' || product_code"
