...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PARTY member-end 'bjaz_hm_policy_usermapping'.
...
derived_columns:
  PARTY_HKEY_NK: "'HUB_PARTY|' || loginname"
  POLICY_HKEY_NK: "'HUB_POLICY|' || policy_ref"
  POLICY_PARTY_HKEY_NK: "'LNK_POLICY_PARTY|' || loginname || '|' || policy_ref"
