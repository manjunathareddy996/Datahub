...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_CHANNEL member-end 'bjaz_generic_loader_log_table'.
...
derived_columns:
  DISTRIBUTION_CHANNEL_HKEY_NK: "'HUB_DISTRIBUTION_CHANNEL|' || partnerid"
  POLICY_HKEY_NK: "'HUB_POLICY|' || pmasterpolicynumber"
  POLICY_CHANNEL_HKEY_NK: "'LNK_POLICY_CHANNEL|' || partnerid || '|' || pmasterpolicynumber"
