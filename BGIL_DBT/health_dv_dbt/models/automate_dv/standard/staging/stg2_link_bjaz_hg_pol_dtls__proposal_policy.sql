...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_POLICY member-end 'bjaz_hg_pol_dtls'.
...
derived_columns:
  ...
  PROPOSAL_POLICY_HKEY_NK: "'LNK_PROPOSAL_POLICY|' || contract_id || '|' || quote_ref_no"
