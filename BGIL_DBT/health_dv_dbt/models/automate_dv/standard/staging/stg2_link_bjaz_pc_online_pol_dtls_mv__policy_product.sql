...
-- STANDARD-MODEL per-table stage() for LNK_POLICY_PRODUCT member-end 'bjaz_pc_online_pol_dtls_mv'.
...
derived_columns:
  ...
  PRODUCT_HKEY_NK: "'HUB_PRODUCT|' || product_4digit_code"
  POLICY_PRODUCT_HKEY_NK: "'LNK_POLICY_PRODUCT|' || contract_id || '|' || product_4digit_code"
