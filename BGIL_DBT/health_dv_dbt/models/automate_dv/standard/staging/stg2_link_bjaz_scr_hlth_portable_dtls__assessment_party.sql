...
-- STANDARD-MODEL per-table stage() for LNK_ASSESSMENT_PARTY member-end 'bjaz_scr_hlth_portable_dtls'.
...
derived_columns:
  ...
  ASSESSMENT_PARTY_HKEY_NK: "'LNK_ASSESSMENT_PARTY|' || scrutiny_no || '|' || member_identifier"
