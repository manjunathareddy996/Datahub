...
-- STANDARD-MODEL per-table stage() for LNK_PROPOSAL_PARTY member-end 'ba_hcp_pp_mem_dtls'.
...
derived_columns:
  ...
  PROPOSAL_PARTY_HKEY_NK: "'LNK_PROPOSAL_PARTY|' || alloted_to || '|' || hi_control_number"
