...
-- STANDARD-MODEL per-table stage() for LNK_ORG_UNIT_HIERARCHY member-end 'bjaz_grp_hlt_dtls'.
...
derived_columns:
  ORG_UNIT_FROM_HKEY_NK: "'HUB_ORG_UNIT|' || branch"
  ORG_UNIT_TO_HKEY_NK: "'HUB_ORG_UNIT|' || department"
  ORG_UNIT_HIERARCHY_HKEY_NK: "'LNK_ORG_UNIT_HIERARCHY|' || branch || '|' || department"
