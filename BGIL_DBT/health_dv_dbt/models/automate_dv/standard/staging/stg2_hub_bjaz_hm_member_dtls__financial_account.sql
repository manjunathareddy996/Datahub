...
-- STANDARD-MODEL per-table stage() for HUB_FINANCIAL_ACCOUNT branch 'BJAZ_HM_MEMBER_DTLS'.
...
derived_columns:
  PARENT_BK: 'bank_ac_no'
  FINANCIAL_ACCOUNT_NK: "'HUB_FINANCIAL_ACCOUNT|' || bank_ac_no"
