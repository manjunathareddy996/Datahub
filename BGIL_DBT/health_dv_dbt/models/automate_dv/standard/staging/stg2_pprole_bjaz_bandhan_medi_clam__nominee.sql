...
-- branch 'BJAZ_BANDHAN_MEDI_CLAM', role = 'nominee'.
-- PARTY_HKEY/POLICY_HKEY/POLICY_PARTY_HKEY reuse the EXACT SAME formula as
-- stg2_link_bjaz_bandhan_medi_clam__policy_party.sql -- guaranteed to match a real
...
hashed_columns:
  ...
  HASHDIFF:
    ...
    columns:
      - 'PARTY_ROLE_TYPE'
derived_columns:
  POLICY_PARTY_HKEY_NK: "'LNK_POLICY_PARTY|' || customer_id || '|' || policy_ref"
