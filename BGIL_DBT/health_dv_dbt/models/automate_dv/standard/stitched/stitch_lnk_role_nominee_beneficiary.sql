...
-- STANDARD-MODEL stitch view for SAT_LNK_ROLE_NOMINEE_BENEFICIARY (HUB_PARTY grain).
...
-- downstream, in the companion stg2_lnk_role_nominee_beneficiary.sql stage() model.
