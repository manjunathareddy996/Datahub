...
-- STANDARD-MODEL stitch view for SAT_ASSESSMENT_UNDERWRITING (HUB_ASSESSMENT grain).
...
-- downstream, in the companion stg2_assessment_underwriting.sql stage() model.
