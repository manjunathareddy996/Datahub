...
-- STANDARD-MODEL stitch view for SAT_PARTY_IDENTITY (HUB_PARTY grain).
-- Attribute-level merge across 48 table(s) sharing this grain: FULL OUTER JOIN + COALESCE.
...
-- downstream, in the companion stg2_party_identity.sql stage() model.
