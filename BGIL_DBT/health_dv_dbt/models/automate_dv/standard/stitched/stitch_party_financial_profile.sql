...
-- STANDARD-MODEL stitch view for SAT_PARTY_FINANCIAL_PROFILE (HUB_PARTY grain).
-- Attribute-level merge across 9 table(s) sharing this grain: FULL OUTER JOIN + COALESCE.
...
-- downstream, in the companion stg2_party_financial_profile.sql stage() model.
