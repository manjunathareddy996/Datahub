...
-- STANDARD-MODEL stitch view for SAT_POLICY_PREMIUM_SUMMARY (HUB_POLICY grain).
-- Attribute-level merge across 18 table(s) sharing this grain: FULL OUTER JOIN + COALESCE.
...
-- downstream, in the companion stg2_policy_premium_summary.sql stage() model.
