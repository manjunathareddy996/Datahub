...
-- Satellite: SAT_PRODUCT_HEALTH_MEMBERSHIP_RULES
...
with source_data as (
    ...
    select parent_bk, natural_addition_newborn_days, natural_addition_rule_indicator, natural_addition_spouse_days, record_source
...
keyed as (
    ...
    select
        ...
        parent_bk,
        natural_addition_newborn_days, natural_addition_rule_indicator, natural_addition_spouse_days,
        record_source
    from source_data
...
hashed as (
    ...
    select
        policy_hkey,
        natural_addition_newborn_days, natural_addition_rule_indicator, natural_addition_spouse_days,
        {{ dbt_utils.generate_surrogate_key(['natural_addition_newborn_days', 'natural_addition_rule_indicator', 'natural_addition_spouse_days']) }} as hashdiff,
        record_source,
