...
with source_data as (
    ...
    select parent_bk, service_level_target, tat_commitment, record_source
...
keyed as (
    ...
    select
        ...
        parent_bk,
        service_level_target, tat_commitment,
        record_source
    from source_data
...
hashed as (
    ...
    select
        agreement_hkey,
        service_level_target, tat_commitment,
        {{ dbt_utils.generate_surrogate_key(['service_level_target', 'tat_commitment']) }} as hashdiff,
        record_source,
