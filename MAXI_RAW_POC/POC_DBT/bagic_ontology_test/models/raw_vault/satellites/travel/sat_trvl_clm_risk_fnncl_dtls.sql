...
-- Travel Claim Risk Financial Details
-- Hub: hub_clm | Attributes: 72
-- Source: NONHLTH_TRV_CLM_VW_DATA_CLAIM_DETAILS_CLAIM_RISK_RISK_ATTRIBUTE_MULTI_SET_PROPERTY_MULTI_SET_DETAIL_PROPERTY
...
source AS (
    SELECT src.*
    FROM {{ ref('stg_trvl_clm_nonhlth_trv_clm_vw_data_cd_clm_risk_ra_msp_msd__553') }} src
),
