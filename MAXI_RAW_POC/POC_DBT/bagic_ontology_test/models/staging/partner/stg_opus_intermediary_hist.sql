...
-- Staging: OPUS intermediary history (SCD2 source)
-- Source: BJAZ_INTERMEDIARY_HIST
-- Versioned intermediary/agent details
-- BK: INTERMEDIARY_ID + PARTNER_ID

WITH source AS (
    SELECT *
    FROM {{ source('raw_opus', 'BJAZ_INTERMEDIARY_HIST') }}
