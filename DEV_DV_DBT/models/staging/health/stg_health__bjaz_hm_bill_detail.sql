-- Staging model for source table BJAZ_HM_BILL_DETAIL (Health LOB).
...
with source as (
    ...
    "AVAILED_ROOM_RENT_PER_DAY"::number as availed_room_rent_per_day,
    ...
    nullif(trim("GENRAL_REMARKS"::varchar), '') as genral_remarks,
    ...
    from {{ source('health_raw', 'BJAZ_HM_BILL_DETAIL') }}
