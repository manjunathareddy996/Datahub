...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_POLICY, table 'BJAZ_IHG_MEM_DTLS_EXTN'.
-- 2 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BJAZ_IHG_MEM_DTLS_EXTN carries a verified HUB_POLICY key
