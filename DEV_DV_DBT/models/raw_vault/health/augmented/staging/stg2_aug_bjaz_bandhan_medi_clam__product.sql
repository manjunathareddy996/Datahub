...
-- AUGMENTED (unconfirmed) per-table stage() for HUB_PRODUCT, table 'BJAZ_BANDHAN_MEDI_CLAM'.
-- 1 previously-unmapped column(s), bucketed by keyword/anchor
-- classification -- NOT mapper-reviewed. BJAZ_BANDHAN_MEDI_CLAM carries a verified HUB_PRODUCT key
